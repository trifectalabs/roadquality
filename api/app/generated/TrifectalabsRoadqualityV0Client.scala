 ...
 * apibuilder:0.12.61 https://app.apibuilder.io/trifectalabs/roadquality/0.0.13/play_2_5_client
 */
package com.trifectalabs.roadquality.v0.models {
   ...
   * @param hidden Whether a segment is user visible or not
   */
  case class Segment(
    ...
    polyline: String,
    createdBy: _root_.java.util.UUID,
    hidden: Boolean
  )
  ...
  case class SegmentUpdateForm(
    name: _root_.scala.Option[String] = None,
    description: _root_.scala.Option[String] = None,
    surfaceRating: _root_.scala.Option[Int] = None,
    trafficRating: _root_.scala.Option[Int] = None,
    surfaceType: _root_.scala.Option[com.trifectalabs.roadquality.v0.models.SurfaceType] = None,
   ...
   * 
   * @param stravaToken Strava API token
   */
  case class User(
    id: _root_.java.util.UUID,
    firstName: String,
    ...
    role: com.trifectalabs.roadquality.v0.models.UserRole,
    stravaToken: String,
    createdAt: _root_.org.joda.time.DateTime,
    updatedAt: _root_.org.joda.time.DateTime,
    deletedAt: _root_.scala.Option[_root_.org.joda.time.DateTime] = None
   ...
   * @param scalaVersion Version of Scala used to build this service
   * @param sbtVersion Version of SBT used to build this service
   */
   ...
   */
  sealed trait PathType extends _root_.scala.Product with _root_.scala.Serializable
  ...
  object PathType {
     ...
     * above.
     */
    val all: scala.List[PathType] = scala.List(Shared, DedicatedLane, BikePath)

    private[this]
    val byName: Map[String, PathType] = all.map(x => x.toString.toLowerCase -> x).toMap
   ...
   */
  sealed trait SurfaceType extends _root_.scala.Product with _root_.scala.Serializable
  ...
  object SurfaceType {
     ...
     */
    case object Gravel extends SurfaceType { override def toString = "gravel" }
    /**
     * Road consisting of paved asphalt
     */
    case object Asphalt extends SurfaceType { override def toString = "asphalt" }
    /**
     * Road consisting of cleared dirt
     */
    case object Dirt extends SurfaceType { override def toString = "dirt" }
     ...
     * with the camel cased values above.
     */
    case class UNDEFINED(override val toString: String) extends SurfaceType
     ...
     * above.
     */
    val all: scala.List[SurfaceType] = scala.List(Gravel, Asphalt, Dirt)

    private[this]
    val byName: Map[String, SurfaceType] = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): SurfaceType = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[SurfaceType] = byName.get(value.toLowerCase)
   ...
   */
  sealed trait UserRole extends _root_.scala.Product with _root_.scala.Serializable
  ...
  object UserRole {
     ...
     * above.
     */
    val all: scala.List[UserRole] = scala.List(User, Admin)

    private[this]
    val byName: Map[String, UserRole] = all.map(x => x.toString.toLowerCase -> x).toMap
...
package com.trifectalabs.roadquality.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsRoadqualitySurfaceType = new play.api.libs.json.Reads[com.trifectalabs.roadquality.v0.models.SurfaceType] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.trifectalabs.roadquality.v0.models.SurfaceType] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.trifectalabs.roadquality.v0.models.SurfaceType(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.trifectalabs.roadquality.v0.models.SurfaceType(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesRoadqualitySurfaceType(obj: com.trifectalabs.roadquality.v0.models.SurfaceType) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectSurfaceType(obj: com.trifectalabs.roadquality.v0.models.SurfaceType) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesRoadqualitySurfaceType: play.api.libs.json.Writes[SurfaceType] = {
      new play.api.libs.json.Writes[com.trifectalabs.roadquality.v0.models.SurfaceType] {
        def writes(obj: com.trifectalabs.roadquality.v0.models.SurfaceType) = {
          jsonWritesRoadqualitySurfaceType(obj)
        }
      }
    }
    ...
    def jsObjectMapRoute(obj: com.trifectalabs.roadquality.v0.models.MapRoute): play.api.libs.json.JsObject = {
    ...
    def jsObjectPoint(obj: com.trifectalabs.roadquality.v0.models.Point): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsRoadqualitySegment: play.api.libs.json.Reads[Segment] = {
      (
        ...
        (__ \ "polyline").read[String] and
        (__ \ "created_by").read[_root_.java.util.UUID] and
        (__ \ "hidden").read[Boolean]
      )(Segment.apply _)
    }

    def jsObjectSegment(obj: com.trifectalabs.roadquality.v0.models.Segment): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id.toString),
        "polyline" -> play.api.libs.json.JsString(obj.polyline),
        "created_by" -> play.api.libs.json.JsString(obj.createdBy.toString),
        "hidden" -> play.api.libs.json.JsBoolean(obj.hidden)
      ) ++ (obj.name match {
    ...
    def jsObjectSegmentCreateForm(obj: com.trifectalabs.roadquality.v0.models.SegmentCreateForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "polylines" -> play.api.libs.json.Json.toJson(obj.polylines),
        "surfaceRating" -> play.api.libs.json.JsNumber(obj.surfaceRating),
        "trafficRating" -> play.api.libs.json.JsNumber(obj.trafficRating),
    ...
    implicit def jsonReadsRoadqualitySegmentRating: play.api.libs.json.Reads[SegmentRating] = {
      (
        (__ \ "id").read[_root_.java.util.UUID] and
        (__ \ "segmentId").read[_root_.java.util.UUID] and
        (__ \ "userId").read[_root_.java.util.UUID] and
        (__ \ "trafficRating").read[Int] and
        (__ \ "surfaceRating").read[Int] and
        (__ \ "surfaceType").read[com.trifectalabs.roadquality.v0.models.SurfaceType] and
        (__ \ "pathType").read[com.trifectalabs.roadquality.v0.models.PathType] and
      ...
      )(SegmentRating.apply _)
    }

    def jsObjectSegmentRating(obj: com.trifectalabs.roadquality.v0.models.SegmentRating): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id.toString),
        "segmentId" -> play.api.libs.json.JsString(obj.segmentId.toString),
    ...
    implicit def jsonWritesRoadqualitySegmentRating: play.api.libs.json.Writes[SegmentRating] = {
      new play.api.libs.json.Writes[com.trifectalabs.roadquality.v0.models.SegmentRating] {
        def writes(obj: com.trifectalabs.roadquality.v0.models.SegmentRating) = {
          jsObjectSegmentRating(obj)
        }
      }
    }
    ...
    implicit def jsonReadsRoadqualitySegmentUpdateForm: play.api.libs.json.Reads[SegmentUpdateForm] = {
      (
        (__ \ "name").readNullable[String] and
        (__ \ "description").readNullable[String] and
        (__ \ "surfaceRating").readNullable[Int] and
        (__ \ "trafficRating").readNullable[Int] and
        (__ \ "surfaceType").readNullable[com.trifectalabs.roadquality.v0.models.SurfaceType] and
        (__ \ "pathType").readNullable[com.trifectalabs.roadquality.v0.models.PathType]
      )(SegmentUpdateForm.apply _)
    }

    def jsObjectSegmentUpdateForm(obj: com.trifectalabs.roadquality.v0.models.SegmentUpdateForm): play.api.libs.json.JsObject = {
      (obj.name match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("name" -> play.api.libs.json.JsString(x))
      }) ++
      ...
      (obj.surfaceType match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("surfaceType" -> play.api.libs.json.JsString(x.toString))
      }) ++
      (obj.pathType match {
        case None => play.api.libs.json.Json.obj()
    ...
    def jsObjectUser(obj: com.trifectalabs.roadquality.v0.models.User): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id.toString),
    ...
    def jsObjectUserUpdateForm(obj: com.trifectalabs.roadquality.v0.models.UserUpdateForm): play.api.libs.json.JsObject = {
      (obj.birthdate match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("birthdate" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(x)))
      }) ++
    ...
    def jsObjectVersionInfo(obj: com.trifectalabs.roadquality.v0.models.VersionInfo): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
...
package com.trifectalabs.roadquality.v0 {
  ...
  object Bindables {
    ...
    // Enum: SurfaceType
    private[this] val enumSurfaceTypeNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.trifectalabs.roadquality.v0.models.SurfaceType.all.mkString(", ")}"

    implicit val pathBindableEnumSurfaceType = new PathBindable.Parsing[com.trifectalabs.roadquality.v0.models.SurfaceType] (
      SurfaceType.fromString(_).get, _.toString, enumSurfaceTypeNotFound
    )

    implicit val queryStringBindableEnumSurfaceType = new QueryStringBindable.Parsing[com.trifectalabs.roadquality.v0.models.SurfaceType](
      SurfaceType.fromString(_).get, _.toString, enumSurfaceTypeNotFound
    )
...
package com.trifectalabs.roadquality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.61 https://app.apibuilder.io/trifectalabs/roadquality/0.0.13/play_2_5_client"
    val Version = "0.0.13"
    val VersionMajor = 0
  ...
  class Client(
    ...
    def segmentRatings: SegmentRatings = SegmentRatings
    ...
    object Info extends Info {
      override def get(
        ...
        _executeRequest("GET", s"/info", requestHeaders = requestHeaders).map {
          ...
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
    }
    ...
    object MapRoutes extends MapRoutes {
      ...
      override def getByPoints(
        points: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.trifectalabs.roadquality.v0.models.MapRoute] = {
        _executeRequest("GET", s"/mapRoutes/${play.utils.UriEncoding.encodePathSegment(points, "UTF-8")}", requestHeaders = requestHeaders).map {
    ...
    object SegmentRatings extends SegmentRatings {
      override def get(
        id: _root_.java.util.UUID,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.trifectalabs.roadquality.v0.models.SegmentRating] = {
        val queryParameters = Seq(
          Some("id" -> id.toString)
        ).flatten

        _executeRequest("GET", s"/segmentRatings", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.roadquality.v0.Client.parseJson("com.trifectalabs.roadquality.v0.models.SegmentRating", r, _.validate[com.trifectalabs.roadquality.v0.models.SegmentRating])
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def post(
        ...
        val queryParameters = Seq(
          Some("id" -> id.toString),
          currentZoomLevel.map("currentZoomLevel" -> _.toString)
        ).flatten

        _executeRequest("POST", s"/segmentRatings", body = Some(payload), queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 400 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 400")
        }
      }
      ...
      override def delete(
        ...
        _executeRequest("DELETE", s"/segmentRatings", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 202 => _root_.com.trifectalabs.roadquality.v0.Client.parseJson("Boolean", r, _.validate[Boolean])
          case r if r.status == 404 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 202, 404")
        }
      }
    }
    ...
    object Segments extends Segments {
      ...
      override def getBoundingbox(
        ...
        _executeRequest("GET", s"/segments/boundingbox", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.roadquality.v0.Client.parseJson("Seq[com.trifectalabs.roadquality.v0.models.Segment]", r, _.validate[Seq[com.trifectalabs.roadquality.v0.models.Segment]])
          case r if r.status == 404 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def post(
        ...
        currentZoomLevel: _root_.scala.Option[Int] = None,
        hidden: _root_.scala.Option[Boolean] = None,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.trifectalabs.roadquality.v0.models.Segment] = {
        ...
        val queryParameters = Seq(
          currentZoomLevel.map("currentZoomLevel" -> _.toString),
          hidden.map("hidden" -> _.toString)
        ).flatten

        _executeRequest("POST", s"/segments", body = Some(payload), queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.com.trifectalabs.roadquality.v0.Client.parseJson("com.trifectalabs.roadquality.v0.models.Segment", r, _.validate[com.trifectalabs.roadquality.v0.models.Segment])
          case r if r.status == 400 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 400")
        }
      ...
      override def put(
        ...
        _executeRequest("PUT", s"/segments", body = Some(payload), queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 400 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r if r.status == 404 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 400, 404")
        }
      }
    }
    ...
    object Users extends Users {
      override def get(
        ...
        _executeRequest("GET", s"/users", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
  ...
  package interfaces {
    ...
    trait Client {
      ...
      def segmentRatings: com.trifectalabs.roadquality.v0.SegmentRatings
  ...
  trait MapRoutes {
    ...
    /**
     * @param points Comma separated lnglat, semicolon separated points
     */
    def getByPoints(
      points: String,
      requestHeaders: Seq[(String, String)] = Nil
