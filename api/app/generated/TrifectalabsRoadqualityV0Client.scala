 ...
 * apibuilder:0.12.61 https://app.apibuilder.io/trifectalabs/roadquality/0.0.12/play_2_5_client
 */
package com.trifectalabs.roadquality.v0.models {
  ...
  case class SegmentCreateForm(
    ...
    surfaceRating: Int,
    trafficRating: Int,
    surface: com.trifectalabs.roadquality.v0.models.SurfaceType,
  ...
  case class SegmentUpdateForm(
    ...
    surface: _root_.scala.Option[com.trifectalabs.roadquality.v0.models.SurfaceType] = None,
  ...
  package object json {
    ...
    implicit def jsonReadsRoadqualitySegment: play.api.libs.json.Reads[Segment] = {
      (
        ...
        (__ \ "polyline").read[String] and
        (__ \ "created_by").read[_root_.java.util.UUID]
      )(Segment.apply _)
    }
    ...
    implicit def jsonReadsRoadqualitySegmentCreateForm: play.api.libs.json.Reads[SegmentCreateForm] = {
      (
        ...
        (__ \ "surface").read[com.trifectalabs.roadquality.v0.models.SurfaceType] and
    ...
    implicit def jsonReadsRoadqualitySegmentUpdateForm: play.api.libs.json.Reads[SegmentUpdateForm] = {
      (
        ...
        (__ \ "surface").readNullable[com.trifectalabs.roadquality.v0.models.SurfaceType] and
...
package com.trifectalabs.roadquality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.61 https://app.apibuilder.io/trifectalabs/roadquality/0.0.12/play_2_5_client"
    val Version = "0.0.12"
    val VersionMajor = 0
