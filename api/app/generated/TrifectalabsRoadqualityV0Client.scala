 ...
 * apidoc:0.11.77 http://www.apidoc.me/trifectalabs/roadquality/0.0.5-dev/play_2_5_client
 */
package com.trifectalabs.roadquality.v0.models {
  ...
  /**
   * Summary of ratings for ways
   */
  case class RatingSummary(
    wayId: _root_.java.util.UUID,
    streetName: String,
...
package com.trifectalabs.roadquality.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsRoadqualityRating: play.api.libs.json.Reads[Rating] = {
      (
        (__ \ "wayId").read[Long] and
    ...
    def jsObjectRating(obj: com.trifectalabs.roadquality.v0.models.Rating) = {
      play.api.libs.json.Json.obj(
        "wayId" -> play.api.libs.json.JsNumber(obj.wayId),
    ...
    implicit def jsonWritesRoadqualityRating: play.api.libs.json.Writes[Rating] = {
      new play.api.libs.json.Writes[com.trifectalabs.roadquality.v0.models.Rating] {
        def writes(obj: com.trifectalabs.roadquality.v0.models.Rating) = {
          jsObjectRating(obj)
        }
      }
    }

    implicit def jsonReadsRoadqualityRatingSummary: play.api.libs.json.Reads[RatingSummary] = {
      (
        (__ \ "wayId").read[_root_.java.util.UUID] and
        (__ \ "streetName").read[String] and
        (__ \ "trafficRating").read[Double] and
        (__ \ "surfaceRating").read[Double] and
        (__ \ "surface").read[com.trifectalabs.roadquality.v0.models.SurfaceType] and
        (__ \ "pathType").read[com.trifectalabs.roadquality.v0.models.PathType] and
        (__ \ "lastUpdatedAt").read[_root_.org.joda.time.DateTime]
      )(RatingSummary.apply _)
    }

    def jsObjectRatingSummary(obj: com.trifectalabs.roadquality.v0.models.RatingSummary) = {
      play.api.libs.json.Json.obj(
        "wayId" -> play.api.libs.json.JsString(obj.wayId.toString),
        "streetName" -> play.api.libs.json.JsString(obj.streetName),
        "trafficRating" -> play.api.libs.json.JsNumber(obj.trafficRating),
        "surfaceRating" -> play.api.libs.json.JsNumber(obj.surfaceRating),
        "surface" -> play.api.libs.json.JsString(obj.surface.toString),
        "pathType" -> play.api.libs.json.JsString(obj.pathType.toString),
        "lastUpdatedAt" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.lastUpdatedAt))
      )
    }

    implicit def jsonWritesRoadqualityRatingSummary: play.api.libs.json.Writes[RatingSummary] = {
      new play.api.libs.json.Writes[com.trifectalabs.roadquality.v0.models.RatingSummary] {
        def writes(obj: com.trifectalabs.roadquality.v0.models.RatingSummary) = {
          jsObjectRatingSummary(obj)
        }
      }
    }
...
package com.trifectalabs.roadquality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.77 http://www.apidoc.me/trifectalabs/roadquality/0.0.5-dev/play_2_5_client"
  ...
  class Client(
    ...
    object Ratings extends Ratings {
      override def get(
        wayId: Long,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.trifectalabs.roadquality.v0.models.Rating] = {
        val queryParameters = Seq(
          Some("wayId" -> wayId.toString)
        ).flatten

        _executeRequest("GET", s"/ratings", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.roadquality.v0.Client.parseJson("com.trifectalabs.roadquality.v0.models.Rating", r, _.validate[com.trifectalabs.roadquality.v0.models.Rating])
          case r => throw new com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def delete(
        ...
        _executeRequest("DELETE", s"/ratings", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
  ...
  package interfaces {
    ...
    trait Client {
      ...
      def ratings: com.trifectalabs.roadquality.v0.Ratings
