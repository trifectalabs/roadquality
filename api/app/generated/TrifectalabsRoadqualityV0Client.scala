 ...
 * apidoc:0.11.86 http://www.apidoc.me/trifectalabs/roadquality/0.0.7/play_2_5_client
 */
...
package com.trifectalabs.roadquality.v0.models {
  ...
  package object json {
    ...
    def jsObjectSegmentRating(obj: com.trifectalabs.roadquality.v0.models.SegmentRating) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id.toString),
...
package com.trifectalabs.roadquality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.86 http://www.apidoc.me/trifectalabs/roadquality/0.0.7/play_2_5_client"
    val Version = "0.0.7"
    val VersionMajor = 0
