 ...
 * apibuilder:0.12.16 https://app.apibuilder.io/trifectalabs/roadquality/0.0.10/play_2_5_client
 */
...
package com.trifectalabs.roadquality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.16 https://app.apibuilder.io/trifectalabs/roadquality/0.0.10/play_2_5_client"
    val Version = "0.0.10"
    val VersionMajor = 0
    ...
    object Users extends Users {
      override def get(
        ...
        _executeRequest("GET", s"/users", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw new com.trifectalabs.roadquality.v0.errors.ValueResponse(r)
          case r => throw new com.trifectalabs.roadquality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
