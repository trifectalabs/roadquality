 ...
 * apidoc:0.11.72 http://www.apidoc.me/trifectalabs/road_quality/0.0.1-dev/play_2_5_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsRoadQualitySegmentForm: play.api.libs.json.Reads[SegmentForm] = {
      (
        ...
        (__ \ "start").read[com.trifectalabs.road.quality.v0.models.Point] and
        (__ \ "end").read[com.trifectalabs.road.quality.v0.models.Point] and
        (__ \ "points").readNullable[Seq[com.trifectalabs.road.quality.v0.models.Point]]
      )(SegmentForm.apply _)
    }
    ...
    def jsObjectSegmentForm(obj: com.trifectalabs.road.quality.v0.models.SegmentForm) = {
      ...
      (obj.points match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("points" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
package com.trifectalabs.road.quality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.72 http://www.apidoc.me/trifectalabs/road_quality/0.0.1-dev/play_2_5_client"
  ...
  class Client(
    ...
    object Segments extends Segments {
      override def getBySegmentId(
        ...
        _executeRequest("GET", s"/segments/${play.utils.UriEncoding.encodePathSegment(segmentId, "UTF-8")}", requestHeaders = requestHeaders).map {
