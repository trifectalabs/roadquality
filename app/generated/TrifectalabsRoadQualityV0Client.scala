 ...
 * apidoc:0.11.76 http://www.apidoc.me/trifectalabs/road_quality/0.0.15/play_2_5_client
 */
...
package com.trifectalabs.road.quality.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsRoadQualityUserRole = new play.api.libs.json.Reads[com.trifectalabs.road.quality.v0.models.UserRole] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.trifectalabs.road.quality.v0.models.UserRole] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.trifectalabs.road.quality.v0.models.UserRole(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.trifectalabs.road.quality.v0.models.UserRole(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesRoadQualityUserRole(obj: com.trifectalabs.road.quality.v0.models.UserRole) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectUserRole(obj: com.trifectalabs.road.quality.v0.models.UserRole) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesRoadQualityUserRole: play.api.libs.json.Writes[UserRole] = {
      new play.api.libs.json.Writes[com.trifectalabs.road.quality.v0.models.UserRole] {
        def writes(obj: com.trifectalabs.road.quality.v0.models.UserRole) = {
    ...
    def jsObjectMapRoute(obj: com.trifectalabs.road.quality.v0.models.MapRoute) = {
    ...
    implicit def jsonWritesRoadQualityMapRoute: play.api.libs.json.Writes[MapRoute] = {
      new play.api.libs.json.Writes[com.trifectalabs.road.quality.v0.models.MapRoute] {
        def writes(obj: com.trifectalabs.road.quality.v0.models.MapRoute) = {
    ...
    def jsObjectUser(obj: com.trifectalabs.road.quality.v0.models.User) = {
      ...
      (obj.deletedAt match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("deleted_at" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(x)))
      })
    }
...
package com.trifectalabs.road.quality.v0 {
  ...
  object Bindables {
    ...
    // Enum: UserRole
    private[this] val enumUserRoleNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.trifectalabs.road.quality.v0.models.UserRole.all.mkString(", ")}"

    implicit val pathBindableEnumUserRole = new PathBindable.Parsing[com.trifectalabs.road.quality.v0.models.UserRole] (
      UserRole.fromString(_).get, _.toString, enumUserRoleNotFound
    )

    implicit val queryStringBindableEnumUserRole = new QueryStringBindable.Parsing[com.trifectalabs.road.quality.v0.models.UserRole](
      UserRole.fromString(_).get, _.toString, enumUserRoleNotFound
    )
...
package com.trifectalabs.road.quality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.76 http://www.apidoc.me/trifectalabs/road_quality/0.0.15/play_2_5_client"
    val Version = "0.0.15"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object MapRoutes extends MapRoutes {
      override def get(
        ...
        endLng: Double,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.trifectalabs.road.quality.v0.models.MapRoute] = {
        ...
        _executeRequest("GET", s"/map_routes", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.road.quality.v0.Client.parseJson("com.trifectalabs.road.quality.v0.models.MapRoute", r, _.validate[com.trifectalabs.road.quality.v0.models.MapRoute])
          case r => throw new com.trifectalabs.road.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def getSnap(
        ...
        _executeRequest("GET", s"/map_routes/snap", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.road.quality.v0.Client.parseJson("com.trifectalabs.road.quality.v0.models.MapRoute", r, _.validate[com.trifectalabs.road.quality.v0.models.MapRoute])
          case r => throw new com.trifectalabs.road.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/map_routes", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.road.quality.v0.Client.parseJson("com.trifectalabs.road.quality.v0.models.MapRoute", r, _.validate[com.trifectalabs.road.quality.v0.models.MapRoute])
          case r => throw new com.trifectalabs.road.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
    ...
    object Users extends Users {
      override def getByUserId(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.trifectalabs.road.quality.v0.models.User] = {
        _executeRequest("GET", s"/users/${userId}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.trifectalabs.road.quality.v0.Client.parseJson("com.trifectalabs.road.quality.v0.models.User", r, _.validate[com.trifectalabs.road.quality.v0.models.User])
          case r if r.status == 404 => throw new com.trifectalabs.road.quality.v0.errors.ValueResponse(r)
          case r => throw new com.trifectalabs.road.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def patchSexByUserIdAndSex(
        ...
        _executeRequest("PATCH", s"/users/${userId}/sex/${play.utils.UriEncoding.encodePathSegment(sex, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 202 => _root_.com.trifectalabs.road.quality.v0.Client.parseJson("com.trifectalabs.road.quality.v0.models.User", r, _.validate[com.trifectalabs.road.quality.v0.models.User])
          case r if r.status == 404 => throw new com.trifectalabs.road.quality.v0.errors.ValueResponse(r)
          case r => throw new com.trifectalabs.road.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 202, 404")
        }
      }
  ...
  package interfaces {
    ...
    trait Client {
      ...
      def mapRoutes: com.trifectalabs.road.quality.v0.MapRoutes
      def segments: com.trifectalabs.road.quality.v0.Segments
      def users: com.trifectalabs.road.quality.v0.Users
    }
