...
var _trifectalabs$aphrodite$Stylesheets$mapNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('map');
var _trifectalabs$aphrodite$Stylesheets$files = _elm_lang$core$Native_Platform.outgoingPort(
	'files',
	function (v) {
...
var _trifectalabs$aphrodite$Stylesheets$MainView = {ctor: 'MainView'};
var _trifectalabs$aphrodite$Stylesheets$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _trifectalabs$aphrodite$Stylesheets$mapNamespace.name, _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$id,
			_trifectalabs$aphrodite$Stylesheets$MainView,
			{
				ctor: '::',
...
var _trifectalabs$aphrodite$Stylesheets$fileStructure = _rtfeldman$elm_css$Css_File$toFileStructure(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			...
			_1: _rtfeldman$elm_css$Css_File$compile(
				{
					ctor: '::',
					_0: _trifectalabs$aphrodite$Stylesheets$css,
					_1: {ctor: '[]'}
				})
		},
		_1: {ctor: '[]'}
	});
var _trifectalabs$aphrodite$Stylesheets$main = A2(_rtfeldman$elm_css$Css_File$compiler, _trifectalabs$aphrodite$Stylesheets$files, _trifectalabs$aphrodite$Stylesheets$fileStructure)();

var _trifectalabs$aphrodite$Main$loginView = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Connect to Strava'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _trifectalabs$aphrodite$Main$toUrl = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'LoginPage':
			return '#/login';
...
var _trifectalabs$aphrodite$Main$parseUrl = F2(
	function (model, location) {
		return model;
	});
var _trifectalabs$aphrodite$Main$encodePoint = function (point) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'lat',
				_1: _elm_lang$core$Json_Encode$float(point.lat)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'lng',
					_1: _elm_lang$core$Json_Encode$float(point.lng)
				},
				_1: {ctor: '[]'}
			}
		});
...
var _trifectalabs$aphrodite$Main$classList = _trifectalabs$aphrodite$Main$_p1.classList;
var _trifectalabs$aphrodite$Main$up = _elm_lang$core$Native_Platform.outgoingPort(
	'up',
	function (v) {
		return v;
	});
var _trifectalabs$aphrodite$Main$setAnchor = _elm_lang$core$Native_Platform.incomingPort(
	'setAnchor',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
...
var _trifectalabs$aphrodite$Main$snapAnchor = _elm_lang$core$Native_Platform.outgoingPort(
	'snapAnchor',
	function (v) {
		return [
			v._0,
...
var _trifectalabs$aphrodite$Main$displayRoute = _elm_lang$core$Native_Platform.outgoingPort(
	'displayRoute',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
...
var _trifectalabs$aphrodite$Main$clearRoute = _elm_lang$core$Native_Platform.outgoingPort(
	'clearRoute',
	function (v) {
		return null;
	});
var _trifectalabs$aphrodite$Main$Model = F5(
	function (a, b, c, d, e) {
		return {anchors: a, anchorOrder: b, route: c, rating: d, page: e};
	});
var _trifectalabs$aphrodite$Main$Route = F2(
	function (a, b) {
		return {distance: a, polyline: b};
	});
var _trifectalabs$aphrodite$Main$decodeRoute = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_trifectalabs$aphrodite$Main$Route)));
var _trifectalabs$aphrodite$Main$Point = F2(
	function (a, b) {
		return {lat: a, lng: b};
	});
...
var _trifectalabs$aphrodite$Main$Segment = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, name: b, description: c, start: d, end: e, polyline: f, rating: g};
	});
var _trifectalabs$aphrodite$Main$decodeSegment = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'rating',
	_elm_lang$core$Json_Decode$float,
	A3(
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'end',
			_trifectalabs$aphrodite$Main$decodePoint,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'start',
				_trifectalabs$aphrodite$Main$decodePoint,
				A3(
					...
					A3(
						...
						A3(
							...
							'id',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_trifectalabs$aphrodite$Main$Segment))))))));
var _trifectalabs$aphrodite$Main$ReceiveSegment = function (a) {
	return {ctor: 'ReceiveSegment', _0: a};
};
var _trifectalabs$aphrodite$Main$SaveSegment = {ctor: 'SaveSegment'};
var _trifectalabs$aphrodite$Main$ChangeRating = function (a) {
	return {ctor: 'ChangeRating', _0: a};
};
var _trifectalabs$aphrodite$Main$ClearAnchors = {ctor: 'ClearAnchors'};
var _trifectalabs$aphrodite$Main$mainView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _trifectalabs$aphrodite$Main$id(_trifectalabs$aphrodite$Stylesheets$MainView),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$value(
								_elm_lang$core$Basics$toString(model.rating)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_trifectalabs$aphrodite$Main$ChangeRating),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_trifectalabs$aphrodite$Main$SaveSegment),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Save Segment'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_trifectalabs$aphrodite$Main$ClearAnchors),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _trifectalabs$aphrodite$Main$view = function (model) {
	var _p2 = model.page;
	switch (_p2.ctor) {
		case 'LoginPage':
			return _trifectalabs$aphrodite$Main$loginView;
		case 'MainPage':
			return _trifectalabs$aphrodite$Main$mainView(model);
		default:
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
...
var _trifectalabs$aphrodite$Main$ReceiveRoute = function (a) {
	return {ctor: 'ReceiveRoute', _0: a};
};
var _trifectalabs$aphrodite$Main$SetAnchorPoint = F2(
	function (a, b) {
		return {ctor: 'SetAnchorPoint', _0: a, _1: b};
	});
var _trifectalabs$aphrodite$Main$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'UrlChange':
				var newModel = A2(_trifectalabs$aphrodite$Main$parseUrl, model, _p3._0);
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'PlaceAnchorPoint':
				var req = _elm_lang$http$Http$request(
					{
						method: 'GET',
						headers: {ctor: '[]'},
						url: _elm_lang$core$String$concat(
							{
								ctor: '::',
								_0: _trifectalabs$aphrodite$Main$host,
								_1: {
									ctor: '::',
									_0: '/map_routes/snap?lat=',
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Basics$toString(_p3._0._1),
										_1: {
											ctor: '::',
											_0: '&lng=',
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Basics$toString(_p3._0._2),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						body: _elm_lang$http$Http$emptyBody,
						expect: _elm_lang$http$Http$expectJson(_trifectalabs$aphrodite$Main$decodePoint),
						timeout: _elm_lang$core$Maybe$Nothing,
						withCredentials: false
					});
				return {
					...
					_1: A2(
						...
						_trifectalabs$aphrodite$Main$SetAnchorPoint(_p3._0._0),
						req)
				};
			case 'SetAnchorPoint':
				if (_p3._1.ctor === 'Err') {
					...
					var anchors = A3(_elm_lang$core$Dict$insert, _p5, _p4, model.anchors);
					var points = _elm_lang$core$Json_Encode$list(
						A2(
							_elm_lang$core$List$map,
							_trifectalabs$aphrodite$Main$encodePoint,
							A2(
								_elm_lang$core$List$filterMap,
								function (id) {
									return A2(_elm_lang$core$Dict$get, id, anchors);
								},
								anchorOrder)));
					var req = _elm_lang$http$Http$request(
						{
							...
							body: _elm_lang$http$Http$jsonBody(points),
							expect: _elm_lang$http$Http$expectJson(_trifectalabs$aphrodite$Main$decodeRoute),
							timeout: _elm_lang$core$Maybe$Nothing,
							withCredentials: false
						});
					var cmd = _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _trifectalabs$aphrodite$Main$snapAnchor(
								{ctor: '_Tuple2', _0: _p5, _1: _p4}),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$http$Http$send, _trifectalabs$aphrodite$Main$ReceiveRoute, req),
								_1: {ctor: '[]'}
							}
						});
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{anchors: anchors, anchorOrder: anchorOrder}),
						_1: cmd
					};
				}
			case 'ReceiveRoute':
				if (_p3._0.ctor === 'Err') {
					...
					var line = A2(
						_elm_lang$core$List$map,
						function (anchor) {
							return {ctor: '_Tuple2', _0: anchor.lat, _1: anchor.lng};
						},
						A2(
							_elm_lang$core$List$filterMap,
							function (id) {
								return A2(_elm_lang$core$Dict$get, id, model.anchors);
							},
							model.anchorOrder));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								route: _elm_lang$core$Maybe$Just(_p3._0._0)
							}),
						_1: _trifectalabs$aphrodite$Main$displayRoute(line)
					};
				}
			case 'ClearAnchors':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							anchors: _elm_lang$core$Dict$empty,
							anchorOrder: {ctor: '[]'},
							route: _elm_lang$core$Maybe$Nothing
						}),
					_1: _trifectalabs$aphrodite$Main$clearRoute(
						{ctor: '_Tuple0'})
				};
			case 'ChangeRating':
				var r = A2(
				...
				var body = _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'points',
							_1: _elm_lang$core$Json_Encode$list(points)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'rating',
								_1: _elm_lang$core$Json_Encode$int(model.rating)
							},
							_1: {ctor: '[]'}
						}
					});
				var req = _elm_lang$http$Http$request(
					{
						...
						expect: _elm_lang$http$Http$expectJson(_trifectalabs$aphrodite$Main$decodeSegment),
						timeout: _elm_lang$core$Maybe$Nothing,
						withCredentials: false
					});
				var cmd = A2(_elm_lang$http$Http$send, _trifectalabs$aphrodite$Main$ReceiveSegment, req);
...
var _trifectalabs$aphrodite$Main$PlaceAnchorPoint = function (a) {
	return {ctor: 'PlaceAnchorPoint', _0: a};
};
var _trifectalabs$aphrodite$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _trifectalabs$aphrodite$Main$setAnchor(_trifectalabs$aphrodite$Main$PlaceAnchorPoint),
			_1: {ctor: '[]'}
		});
};
var _trifectalabs$aphrodite$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _trifectalabs$aphrodite$Main$AccountPage = {ctor: 'AccountPage'};
var _trifectalabs$aphrodite$Main$MainPage = {ctor: 'MainPage'};
var _trifectalabs$aphrodite$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: {
			anchors: _elm_lang$core$Dict$empty,
			...
			route: _elm_lang$core$Maybe$Nothing,
			rating: 5,
			page: _trifectalabs$aphrodite$Main$MainPage
		},
		_1: _trifectalabs$aphrodite$Main$up(true)
	};
};
var _trifectalabs$aphrodite$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_trifectalabs$aphrodite$Main$UrlChange,
	{init: _trifectalabs$aphrodite$Main$init, view: _trifectalabs$aphrodite$Main$view, update: _trifectalabs$aphrodite$Main$update, subscriptions: _trifectalabs$aphrodite$Main$subscriptions})();
var _trifectalabs$aphrodite$Main$LoginPage = {ctor: 'LoginPage'};
var _trifectalabs$aphrodite$Main$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _trifectalabs$aphrodite$Main$MainPage, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_trifectalabs$aphrodite$Main$AccountPage,
				_evancz$url_parser$UrlParser$s('account')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_trifectalabs$aphrodite$Main$LoginPage,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _trifectalabs$aphrodite$Main$main !== 'undefined') {
    _trifectalabs$aphrodite$Main$main(Elm['Main'], 'Main', undefined);
}
